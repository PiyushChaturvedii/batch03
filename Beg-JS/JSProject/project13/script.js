...
var random_colors = ["D2001A", "FFDE00", "E80F88", "25316D", "FA9494", "224B0C", "F0EABE"];
...
createStickyNote = (text) => {
    ...
    note.setAttribute("style", `margin:${random_margin[(Math.random() * random_margin.length)]}; background-color:${random_colors[(Math.random() * random_colors.length)]}`);
